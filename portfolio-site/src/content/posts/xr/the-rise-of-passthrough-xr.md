...
img: /assets/posts/passthrough-xr.jpg
...
I'm seeing this shift firsthand. Whether it's crafting immersive training experiences or building relaxing, mixed reality worlds, Passthrough is allowing us to design for environments that aren't just *virtual* or *real*, they're a combination of both.
...
I've been exploring these ideas too. In some internal prototypes, I've used Passthrough to make interfaces feel like part of the physical space, projecting a floating UI above a desk or letting the user "tap" physical buttons that correspond to virtual actions.
...
I'm committed to staying close to where this movement is heading. Whether it's games, tools, or platforms, I believe the future of XR is mixed and Passthrough is leading the way.
